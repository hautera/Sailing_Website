...
function display( picPath, albumID ){
   ...
   picRef.getDownloadURL().then( function( URL ){
         document.getElementById("pic").innerHTML += "<a href='/pictures/albums.php?album="+albumID+"'><span class='imag_container'><img src=\"" +URL+"\" class='smoll_img'><h3 class='img_caption'>"+albumID+"</h3></span></a>";
