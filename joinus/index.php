...
<body>
	...
	<h3>Step 1:</h3><p>Fill <a href="#">this</a>(it's coming soon) out. It's a thing we need so we don't get in trouble with the RSO office.</p>
	<h3>Step 2:</h3><P>Decide when you can go to practice. We are currently not practcing right now, as most--but not all--of us don't want to lose our fingers. Check back here later.</P>
	<h3>Step 3:</h3><p>Tell us who you are, how much you've sailed <a href="#">(it's totally okay if you haven't)</a>, and when you want to sail with us. You can do that <a href="#">here.</a></p>
